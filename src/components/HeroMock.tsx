...
function ReviewRow({ stars, text, visible, hidden }: { stars: number; text: string; visible?: boolean; hidden?: boolean }) {
  return (
    <div style={{
...
function Annotation({ text, style, flipped }: { text: string; style: React.CSSProperties; flipped?: boolean }) {
  return (
    <div style={{
      position: 'absolute',
      maxWidth: 180,
