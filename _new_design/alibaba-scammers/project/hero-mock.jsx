      ...
      >
        ...
        <div style={{display: "grid", gridTemplateColumns: "88px 1fr", gap: 14, alignItems: "flex-start"}}>
          ...
          <div>
            ...
            <div style={{display: "flex", gap: 16, marginTop: 8, fontSize: 12, color: "var(--muted)"}}>
              <span>
                <span style={{color: "#d4a017", fontSize: 13}}>★★★★★</span> 4.9 / 5.0
              </span>
        ...
        <div>
          ...
          <div style={{textAlign: "center", marginTop: 10}}>
            <span style={{fontSize: 10, color: "var(--muted-2)", textDecoration: "underline"}}>Show all 247 reviews</span>
          </div>
        </div>
      </div>

      {/* Annotation arrows */}
      <Annotation style={{top: "46%", right: -18, transform: "translateX(100%) rotate(2deg)"}} text={"These three reports never\nappear in the seller score"} />
      <Annotation style={{top: 22, left: -32, transform: "translateX(-100%) rotate(-3deg)"}} text={"5-star average,\nno red flags shown"} flipped />
    </div>
  );
}
