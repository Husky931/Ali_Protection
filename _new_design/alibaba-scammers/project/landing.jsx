  ...
  return (
    <section
      style={{
        ...
        paddingBottom: 100,
        background:
          "radial-gradient(1200px 600px at 110% -10%, oklch(0.94 0.07 65 / .8), transparent 60%), radial-gradient(900px 500px at -10% 40%, oklch(0.96 0.04 75 / .7), transparent 60%)",
      ...
      >
        <div>
          ...
          <h1 className="display">
            ...
            <span className="marker" style={{fontStyle: "italic", fontFamily: "var(--serif)", fontWeight: 600}}>
              Alibaba
            </span>{" "}
            deal.
          </h1>
    ...
    <section id="why" style={{background: "var(--bg)", borderBottom: "1px solid var(--line)"}}>
      <div className="container" style={{display: "grid", gridTemplateColumns: "0.9fr 1.1fr", gap: 64, alignItems: "flex-start"}}>
        ...
        <div style={{fontFamily: "var(--serif)", fontSize: 19, lineHeight: 1.65, color: "var(--ink-2)", maxWidth: 580}}>
          <p style={{marginTop: 0}}>
            In 2024 I wired $4,200 to a verified Gold Supplier for a thousand LED bulbs. The samples were perfect. The bulk shipment never came. Tracking went
            dead the day after I paid the balance.
          </p>
          <p>
            Trade Assurance asked for documents I&rsquo;d already submitted twice, then closed the dispute because I &ldquo;missed a 72-hour response
            window.&rdquo; The seller&rsquo;s 4.9-star rating never moved. New buyers had no way of knowing.
          </p>
          <p>
            I asked around. Everyone I talked to had a story like this — or knew someone who did. The marketplace has every incentive to make those stories
            invisible. Buyers have nowhere to put them.
          </p>
    ...
    <section id="how" style={{background: "var(--bg-2)", borderBottom: "1px solid var(--line)"}}>
      <div className="container">
        <div style={{marginBottom: 44, maxWidth: 580}}>
          ...
          <h2 style={{fontSize: 36, marginTop: 12, letterSpacing: "-.03em", lineHeight: 1.1}}>Three steps. No accounts. No spam.</h2>
        </div>
        <div className="grid-3">
          {steps.map(s => (
            ...
            >
              ...
              <p className="muted" style={{margin: 0, fontSize: 14, lineHeight: 1.55}} dangerouslySetInnerHTML={{__html: s.body}} />
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="container">
        <div style={{display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 28, flexWrap: "wrap", gap: 16}}>
          <div style={{maxWidth: 580}}>
            <h2 style={{fontSize: 32, marginTop: 12, letterSpacing: "-.025em", lineHeight: 1.15}}>Search any seller before you wire money.</h2>
          </div>
  ...
  return (
    ...
    >
      <div>
        ...
        <h3 style={{fontSize: 17, letterSpacing: "-.015em", marginBottom: 4}}>{r.sellerName}</h3>
        <div className="muted small" style={{marginBottom: 10}}>
          {r.productName} · qty {r.quantity.toLocaleString()}
        </div>
        <p style={{margin: 0, color: "var(--ink-2)", fontSize: 14.5, lineHeight: 1.55, maxWidth: 720}}>&ldquo;{r.snippet}&rdquo;</p>
      </div>
      <div style={{textAlign: "right", minWidth: 130, display: "flex", flexDirection: "column", justifyContent: "space-between"}}>
        <div>
          ...
          <div className="muted small" style={{fontFamily: "var(--mono)", fontSize: 11}}>
            {r.currency}
          </div>
        </div>
